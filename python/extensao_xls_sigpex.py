...
DIMENSAO_EXTENSAO      = 2   # documento_ods.id_dimensao
TIPO_PROJ_EXTENSAO     = 2   # documento_ods.id_tipo_documento
...
def setup_logging():
    logging.basicConfig(
        ...
        handlers=[
            ...
            logging.FileHandler("projetos_extensao.log", encoding="utf-8")
        ]
    )
