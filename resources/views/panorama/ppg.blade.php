            ...
            <div class="card-body">
                <div class="row">
                    <div class="col-md-2 text-center">
                        <i class="fa fa-graduation-cap" style="font-size: 80px; color: #17a2b8;"></i>
                    </div>
                    <div class="col-md-10">
                        <h3 style="color: #17a2b8;">{{ $ppg->nm_curso_cur }}</h3>
                        ...
                        <div class="row">
                            <div class="col-md-4">
                                <div class="card text-center" style="background: #f8f9fa;">
                                    <div class="card-body">
                                        <h2 class="mb-0" style="color: #17a2b8;">
    ...
    <div class="col-md-8">
        ...
        <div class="card mb-4">
            ...
            <div class="card-body">
                ...
                @else
                    <p class="text-muted text-center">Nenhum documento encontrado para este programa.</p>
                @endif
            </div>
        </div>
    </div>
                    ...
                    <ul class="list-group">
                        @foreach($dimensoes as $dim)
                            <li class="list-group-item d-flex justify-content-between align-items-center">
                                {{ $dim->nome }}
                                <span class="badge badge-info badge-pill">{{ $dim->total }}</span>
                            </li>
                        @endforeach
                    </ul>
                @else
