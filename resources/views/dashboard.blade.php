...
<div class="row">
    ...
    <div class="col-md-9">
        ...
        <div class="row mt-3 d-none" id="perfil-docente">
            ...
            <div class="col-md-8">
                <h5 class="mb-2 mt-3" id="nm_docente"></h5>
                <span id="nm_ppg"></span>
                <p class="mb-2"><img style="max-width: 20px; margin-top: -5px !important; margin-right: 5px;" src="{{ asset('img/lattes.png') }}" class="img-fluid mt-1" alt="Ícone Lattes"><a class="url_lattes" href="" target="_blank"></a></p>
                <p class="mb-2"><img style="max-width: 20px; margin-top: -5px !important; margin-right: 5px;" src="{{ asset('img/orcid.png') }}" class="img-fluid mt-1" alt="Ícone Orcid"><a class="url_orcid" href="" target="_blank"></a></p>
            ...
            function carregaDocente(ppg, docente){
                ...
                $.ajax({
                    ...
                    success: function(data) {
                        ...
                        $(".url_lattes").text(data.lattes);
                        $(".url_orcid").attr('href', data.orcid);
                        $(".url_orcid").text(data.orcid);
